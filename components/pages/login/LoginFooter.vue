...
<template>
    <footer>
        <div class="container-fluid">
            <div class="row">
                <div
                    class="col-4 col-sm-4 col-md-7 d-flex align-items-center justify-content-start"
                >
                    <a href="#">
                        <img src="/images/brt-icone.svg" />
                    </a>
                ...
                <div
                    class="col-8 col-sm-8 col-md-5 d-flex align-items-center justify-content-end"
                >
                    Copyright © 2023 - Grupo BRT
                </div>
            </div>
        </div>
    </footer>
