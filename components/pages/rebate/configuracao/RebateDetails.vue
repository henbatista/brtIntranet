              ...
              <div class="relative py-6 overflow-hidden rounded-md bg-gradient-to-r from-[#202D3B] to-[#202D3B] lg:py-5 md:px-6 lg:p-16 md:shadow-sm md:bg-purple-1000" data-primary="purple-600" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                  <div class="flex flex-col items-center">
                      <div class="w-full flex justify-start mb-4">
                          <p class="text-sm leading-6 text-white"><strong>Criado por:</strong> {{ data.rebate_template_created_by }}</p>
                      </div>
                      <div class="w-full flex justify-end mb-4 -mt-10">
                        <strong class="text-white text-sm">Status:&nbsp;  </strong><p class="text-sm " :class="statusClass"> {{ rebateStatus }}</p>
                      </div>
                      <h2 class="text-xl font-extrabold leading-9 tracking-tight text-white sm:text-2xl sm:leading-1 mb-4 text-center">
                          <strong>Nome do Template:</strong> {{ data.rebate_template_name }}
                      </h2>
          
                      <div class="w-full text-center">
                          <p class="text-sm leading-6 text-white"><strong>Descrição:</strong> <span v-html="data.rebate_template_comments"></span></p>
                      </div>
                  </div>
              </div>
          </div>
